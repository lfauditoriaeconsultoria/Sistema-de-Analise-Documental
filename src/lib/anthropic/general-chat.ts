...
- **OEA (Operador Econômico Autorizado)**: Programa da Receita Federal do Brasil regulamentado pela Instrução Normativa RFB Nº 2.318 de 26/03/2026 e pela Portaria COANA Nº 187 de 02/04/2026. Requisitos de habilitação nas modalidades Conformidade (OEA-C) e Segurança (OEA-S). Critérios de auditoria, processo de certificação e renovação, benefícios alfandegários.
